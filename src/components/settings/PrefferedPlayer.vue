...
<div class="w-full flex flex-row place-items-center">
  <div class="flex flex-col flex-2 min-w-0" v-if="config">
    <p class="text-sm flex flex-row items-center gap-1"><File :size="14"/>Preferred Player</p>
    <p class="text-xs text-base-content/50">Which player use to launch your Steam games</p>
  </div>
